...
/// ```
pub fn read_image_jpeg<P>(file_path: P) -> Result<Image<u8, 3>, IoError>
where
    P: Into<PathBuf>,
{
...
pub fn write_image_jpeg<P>(file_path: P, image: &Image<u8, 3>) -> Result<(), IoError>
where
    P: Into<PathBuf>,
{
    let file_path = file_path.into();
...
/// assert_eq!(image.num_channels(), 3);
/// ```
pub fn read_image_any<P>(file_path: P) -> Result<Image<u8, 3>, IoError>
where
    P: Into<PathBuf>,
{
    let file_path = file_path.into();
